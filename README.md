...
### Cybersecurity Data Scientist · AI Security · Cloud, SaaS & Browser Security · Trust & Safety

**Building measurable, explainable security systems across AI agents, identity, browser and SaaS exposure, detection, cloud resilience, content integrity, threat intelligence, and critical infrastructure.**
...
Evaluates proposed tool calls using user intent, tool risk, sensitive-data context, delegation state, and multi-step trajectory history.

**Focus:** Runtime AI security · MCP-aware governance · least privilege · DLP
...
Versioned detections with Sigma-style rules, KQL compilation, malicious/benign replay, precision/recall/FPR release gates, ATT&CK coverage, analyst feedback, API, and CI.
...
Combines behavioral, temporal, and graph signals with calibration, expected-loss optimization, review-capacity thresholds, and explainable policy decisions.
...
Defensive IT/OT/ICS-style simulation with safety envelopes, AI/data provenance, least-privilege controls, human override, degraded-safe operation, and resilience scoring.

**Focus:** Critical infrastructure · AI assurance · OT/ICS · resilience

</td>
</tr>
</table>

> **Evaluation note:** public security datasets and scenarios across these projects are intentionally synthetic or simulation-based where real telemetry would be sensitive. Each repository documents its evaluation boundary and what its metrics do—and do not—establish.
...
- **Decision quality matters** — optimize not just model scores, but also false positives, reviewer workload, intervention timing, and operational risk.
...
<details>
<summary><strong>Security engineering, threat intelligence & architecture</strong></summary>
<br>

- **[AI Data Center Security Digital Twin](https://github.com/VinayK88/ai-datacenter-security-digital-twin)** — directed compromise graphs, cyber-physical telemetry, blast radius, systemic chokepoints, and defensive control what-if analysis.
...
- **[LLM Security Evaluation Lab](https://github.com/VinayK88/LLM-Security-Evaluation-Lab)** — safeguards, misuse trajectories, prompt injection, tool safety, and intervention evaluation.
...
- **[Model Containment Eval Lab](https://github.com/VinayK88/model-containment-eval-lab)** — shutdown compliance, tripwires, trace monitoring, and containment experiments.
...
[**BrowserGuard**](https://github.com/VinayK88/BrowserGuard) · [**SaaSGraph**](https://github.com/VinayK88/SaaSGraph) · [**CloudRescue**](https://github.com/VinayK88/CloudRescue) · [**AgentShield**](https://github.com/VinayK88/AgentShield)  
[**AgentAtlas**](https://github.com/VinayK88/AgentAtlas) · [**DetectionForge**](https://github.com/VinayK88/DetectionForge) · [**RiskOS**](https://github.com/VinayK88/riskos) · [**DeepTrace**](https://github.com/VinayK88/DeepTrace)  
[**InfraGuard AI**](https://github.com/VinayK88/InfraGuard-AI) · [**AI Data Center Digital Twin**](https://github.com/VinayK88/ai-datacenter-security-digital-twin)
